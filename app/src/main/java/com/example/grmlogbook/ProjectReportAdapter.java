...
public class ProjectReportAdapter extends RecyclerView.Adapter<ProjectReportAdapter.MyViewHolder> {
    ...
    public ProjectReportAdapter(Context mainActivityUser, ArrayList<Projectbean> projectbeans,
    ...
    public ProjectReportAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.projectdetail_row_report, parent, false);

        return new ProjectReportAdapter.MyViewHolder(itemView);
    }
