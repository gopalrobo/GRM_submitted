...
public class AssignAttendeeAdapter extends RecyclerView.Adapter<AssignAttendeeAdapter.MyViewHolder>
        implements Filterable {
    private Context context;
    private ArrayList<RegMainbean> contactList;
    private ArrayList<RegMainbean> contactListFiltered;
    private OnInvestMeetingCheck listener;
    ...
    public AssignAttendeeAdapter(Context context, ArrayList<RegMainbean> contactList,
                                 OnInvestMeetingCheck listener, HashSet<String> selectInvest, String type) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.inevestCheck.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                listener.onChecked(position, isChecked,type);
            }
        });
